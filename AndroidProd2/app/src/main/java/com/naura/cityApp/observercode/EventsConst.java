...
public class EventsConst {
    ...
    public static String selectCityLoad="selectCityLoad";
    ...
    public static String ErrorCityFound="ErrorCityFound";
    public static String CityDelComplete="CityDelComplete";
}
